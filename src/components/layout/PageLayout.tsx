        ...
        <Container size={BODY_MAX_WIDTH} h="100%">
          <Group h="100%" align="center" justify="space-between">
            ...
            <Group gap="sm" visibleFrom="sm">
              <Button component={Link} href="/" color="#FF5500" variant="subtle">Domů</Button>
              <Button component={Link} href="/bazar" color="#FF5500" variant="subtle">Bazar</Button>
              <Button component={Link} href="/bazar/novy" color="#FF5500">+ Nový inzerát</Button>
            </Group>
        ...
        <Container size={BODY_MAX_WIDTH} px="md" mt="xl">
          ...
          <Group justify="space-between" align="flex-start" pb="xl" wrap="wrap" gap="xl">
            ...
            <Stack gap="xs">
              ...
              <Anchor component={Link} href="/" c="dimmed" size="sm">Domů</Anchor>
              <Anchor component={Link} href="/bazar" c="dimmed" size="sm">Bazar</Anchor>
              <Anchor component={Link} href="/bazar/novy" c="dimmed" size="sm">Nový inzerát</Anchor>
            </Stack>

            <Stack gap="xs">
              <Text fw={500} mb="xs">Kontakt</Text>
              <Text size="sm" c="dimmed">Blogic s.r.o.</Text>
              <Anchor href="mailto:info@blogic.cz" c="dimmed" size="sm">info@blogic.cz</Anchor>
            </Stack>
